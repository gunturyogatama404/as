...
local Window = Rayfield:CreateWindow({
    Name = "KONTOL FISH IT - FINAL INTEGRATED VERSION",
    LoadingTitle = "KONTOL FISH IT - FINAL INTEGRATED VERSION",
    LoadingSubtitle = "DEVELOPER BY KONTOL",
...
local TELEGRAM_BOT_TOKEN = "8434133563:AAE6XeAjmEZY8tziKJzupg3B6TE2naOnVgw"
...
local function FancyHeader()
    if TelegramConfig.UseFancyFont then
        return "KONTOL SCRIPT FISH IT"
    else
        return "KONTOL SCRIPT FISH IT V1"
    end
end
...
local function BuildTelegramMessage(fishInfo, fishId, fishRarity, weight)
    ...
    local message = "```\n"
    message = message .. "KONTOL SCRIPT FISH IT\n"
    message = message .. "DEVELOPER: KONTOL\n"
    message = message .. "========================================\n"
    message = message .. "\n"
    ...
    message = message .. "     ROBLOX: @KONTOL7z\n"
    message = message .. "\n"
...
local function BuildQuestTelegramMessage(questName, taskName, progress, statusType)
    ...
    message = message .. "\n"
    message = message .. "DEVELOPER SOCIALS\n"
    message = message .. "     TIKTOK: @KONTOLxit\n"
...
local function StartUltraInstantBite()
    ...
    task.spawn(function()
        while UltraBiteActive do
            ...
            pcall(function()
                Window:SetWindowName("KONTOL ULTRA | " .. currentRate .. " FISH/SEC")
            end)
...
local function StopUltraInstantBite()
    ...
    pcall(function()
        Window:SetWindowName("KONTOL ULTRA INSTANT BITE")
    end)
end
...
local RejoinSaveFile = "KONTOLRejoinData_" .. LocalPlayer.UserId .. ".json"
...
task.spawn(function()
    while task.wait(1) do
        ...
        if allTasksCompleted and questProgress >= 100 then
            ...
            completionMessage = completionMessage .. "KONTOL SCRIPT FISH IT - MISSION ACCOMPLISHED!\n"
            completionMessage = completionMessage .. "DEVELOPER: KONTOL\n"
        ...
        if not currentTask then
            ...
            if currentTask then
                ...
                nextTaskMessage = nextTaskMessage .. "KONTOL SCRIPT FISH IT - NEXT TASK STARTED\n"
                nextTaskMessage = nextTaskMessage .. "DEVELOPER: KONTOL\n"
        ...
        if currentTask.percent >= 100 and not QuestState.Fishing then
            ...
            taskCompleteMessage = taskCompleteMessage .. "KONTOL SCRIPT FISH IT - TASK COMPLETED\n"
            taskCompleteMessage = taskCompleteMessage .. "DEVELOPER: KONTOL\n"
...
local function CreateUI()
    ...
    Tab6:CreateParagraph({
        Title = "KONTOL FISH IT - FINAL INTEGRATED VERSION",
    ...
    Tab6:CreateButton({
        ...
        Callback = function()
            ...
            print("=======================================")
            print("  KONTOL FISH IT - FINAL INTEGRATED")
    ...
    task.wait(1)
    Rayfield:Notify({
        Title = "KONTOL FISH IT - FINAL INTEGRATED",
        Content = "All systems ready - Database + Quest + Hook loaded!",
        Duration = 5
    })
    
    print("=======================================")
    print("  KONTOL FISH IT - FINAL INTEGRATED LOADED")
    print("  Status: ALL FEATURES WORKING")
    print("  Developer: KONTOL")
...
-- MAIN EXECUTION
print("Initializing KONTOL FISH IT - FINAL INTEGRATED VERSION...")
...
if not success then
    ...
    print("KONTOL FISH IT - FINAL INTEGRATED VERSION LOADED SUCCESSFULLY")
    print("Complete System - All Features Working Perfectly")
    print("Developer by KONTOL")
    print("Ready to use!")
    print("")
    print("INTEGRATED SYSTEMS:")
